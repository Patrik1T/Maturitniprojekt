# Generated by Django 5.0.6 on 2025-01-05 21:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0003_test_remove_question_answer_alter_question_text_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='question',
            name='test',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='users.test'),
        ),
        migrations.AlterField(
            model_name='test',
            name='name',
