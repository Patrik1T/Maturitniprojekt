...
STATICFILES_DIRS = [
    r'C:\Revas\revas\users\static',  # Cesta k složce obsahující zdrojové statické soubory
]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Cesta k cílové složce pro collectstatic
BASE_DIR = Path(__file__).resolve().parent.parent
